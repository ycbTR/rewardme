  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested activity" do
        ...
        Activity.any_instance.should_receive(:update_attributes).with({ "description" => "MyText" })
        put :update, {:id => activity.to_param, :activity => { "description" => "MyText" }}, valid_session
      end
