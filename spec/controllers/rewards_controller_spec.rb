  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reward as @reward" do
        ...
        post :create, {:reward => { "name" => "invalid value" }}, valid_session
        assigns(:reward).should be_a_new(Reward)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reward" do
        ...
        Reward.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => reward.to_param, :reward => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reward as @reward" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reward.any_instance.stub(:save).and_return(false)
        put :update, {:id => reward.to_param, :reward => { "name" => "invalid value" }}, valid_session
        assigns(:reward).should eq(reward)
      end
